          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="./assets/images/faces/face1.jpg" alt="image"/><span class="online"/></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="./assets/images/faces/face2.jpg" alt="image"/><span class="offline"/></div>
                <div class="info">
