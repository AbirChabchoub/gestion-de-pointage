      ...
      <ul className="nav">
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="tables">
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> <a className="nav-link" href="./public/pages/tables/basic-table.html">Journal de présence</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/tables/basic-table.html">Pointage manuelle</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/tables/basic-table.html">Cumul personnel</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/tables/basic-table.html">Cumul par département</a></li>
        ...
        <li className="nav-item">
          ...
          <div className="collapse" id="icons">
            <ul className="nav flex-column sub-menu">
              <li className="nav-item"> <a className="nav-link" href="./public/pages/icons/mdi.html">Rapport journalier/Départements</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/icons/mdi.html">Rapport journalier/Tous les employés</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/icons/mdi.html">Rapport mensuelle/Département</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/icons/mdi.html">Rapport mensuelle/Tous les employés</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/icons/mdi.html">Rapport heure supp</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/icons/mdi.html">Rapport des abscences/Jour</a></li>
              <li className="nav-item"> <a className="nav-link" href="./public/pages/icons/mdi.html">Rapport des abscences/Employé</a></li>
